...
<head>
    ...
    <title>We Received Your Application — KawachTech</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 32px 40px;">
                            ...
                            <p style="margin: 0 0 24px 0; font-size: 15px; line-height: 24px; color: #9CA3AF;">
                                Thank you for applying to KawachTech for the <strong style="color:#E5E7EB;">{{ $application->job_title }}</strong> position. We've received your application and resume, and our hiring team will review it shortly. If your profile is a good fit, we'll reach out to schedule the next step.
                            </p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #171E2E; border: 1px solid #1F2937; border-radius: 8px;">
                                <tr>
                                    <td width="35%" style="padding: 14px 16px; font-size: 13px; font-weight: 600; color: #6B7280; border-bottom: 1px solid #1F2937; text-transform: uppercase; letter-spacing: 0.5px;">Position</td>
                                    <td style="padding: 14px 16px; font-size: 14px; color: #E5E7EB; border-bottom: 1px solid #1F2937; font-weight: 500;">
                                        <span style="color: #10B981;">{{ $application->job_title }}</span>
                                    </td>
                                </tr>

                                @if(!empty($application->experience))
                                <tr>
                                    <td width="35%" style="padding: 14px 16px; font-size: 13px; font-weight: 600; color: #6B7280; border-bottom: 1px solid #1F2937; text-transform: uppercase; letter-spacing: 0.5px;">Experience</td>
                                    <td style="padding: 14px 16px; font-size: 14px; color: #E5E7EB; border-bottom: 1px solid #1F2937;">{{ $application->experience }}</td>
                                </tr>
                                @endif

                                <tr>
                                    <td width="35%" style="padding: 14px 16px; font-size: 13px; font-weight: 600; color: #6B7280; border-bottom: 1px solid #1F2937; text-transform: uppercase; letter-spacing: 0.5px;">Resume</td>
                                    <td style="padding: 14px 16px; font-size: 14px; color: #E5E7EB; border-bottom: 1px solid #1F2937;">{{ $application->resume_original_name ?? 'Received' }}</td>
                                </tr>

                                <tr>
                                    <td width="35%" style="padding: 14px 16px; font-size: 13px; font-weight: 600; color: #6B7280; vertical-align: top; text-transform: uppercase; letter-spacing: 0.5px;">Submitted</td>
                                    <td style="padding: 14px 16px; font-size: 14px; color: #9CA3AF; line-height: 20px;">
                                        {{ $application->created_at->format('d M Y, H:i') }} UTC
                                    </td>
                                </tr>
                            </table>

                            <p style="margin: 32px 0 0 0; font-size: 14px; line-height: 22px; color: #9CA3AF;">
                                If anything changes — an updated resume, additional links — just reply directly to this email.
                            </p>
                        </td>
                    </tr>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                <tr>
                                    <td style="font-size: 14px; color: #E5E7EB; line-height: 20px;">
                                        Best regards,<br>
                                        <strong style="color: #FFFFFF; font-weight: 600;">The KawachTech Hiring Team</strong><br>
