...
<head>
    ...
    <title>We Received Your Request — KawachTech</title>
</head>
                    ...
                    <tr>
                        <td style="padding: 40px 40px 32px 40px;">
                            <h1 style="margin: 0 0 16px 0; font-size: 24px; font-weight: 700; color: #FFFFFF; letter-spacing: -0.5px;">
                                Hello {{ $hire->full_name }},
                            </h1>
                            <p style="margin: 0 0 24px 0; font-size: 15px; line-height: 24px; color: #9CA3AF;">
                                Thank you for reaching out to KawachTech to hire <strong style="color:#E5E7EB;">{{ $hire->developer_type }}</strong>. We've received your requirements and our team is matching them against available engineers right now. Expect a reply with next steps within 24 hours.
                            </p>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color: #171E2E; border: 1px solid #1F2937; border-radius: 8px;">
                                <tr>
                                    <td width="35%" style="padding: 14px 16px; font-size: 13px; font-weight: 600; color: #6B7280; border-bottom: 1px solid #1F2937; text-transform: uppercase; letter-spacing: 0.5px;">Role</td>
                                    <td style="padding: 14px 16px; font-size: 14px; color: #E5E7EB; border-bottom: 1px solid #1F2937; font-weight: 500;">
                                        <span style="color: #10B981;">{{ $hire->developer_type }}</span>
                                    </td>
                                </tr>

                                @if(!empty($hire->company))
                                <tr>
                                    ...
                                    <td style="padding: 14px 16px; font-size: 14px; color: #E5E7EB; border-bottom: 1px solid #1F2937;">{{ $hire->company }}</td>
                                </tr>
                                @endif

                                @if(!empty($hire->engagement_type))
                                <tr>
                                    <td width="35%" style="padding: 14px 16px; font-size: 13px; font-weight: 600; color: #6B7280; border-bottom: 1px solid #1F2937; text-transform: uppercase; letter-spacing: 0.5px;">Engagement</td>
                                    <td style="padding: 14px 16px; font-size: 14px; color: #E5E7EB; border-bottom: 1px solid #1F2937;">{{ $hire->engagement_type }}</td>
                                </tr>
                                @endif

                                @if(!empty($hire->team_size))
                                <tr>
                                    <td width="35%" style="padding: 14px 16px; font-size: 13px; font-weight: 600; color: #6B7280; border-bottom: 1px solid #1F2937; text-transform: uppercase; letter-spacing: 0.5px;">Team Size</td>
                                    <td style="padding: 14px 16px; font-size: 14px; color: #E5E7EB; border-bottom: 1px solid #1F2937;">{{ $hire->team_size }}</td>
                                </tr>
                                @endif

                                @if(!empty($hire->budget))
                                <tr>
                                    ...
                                    <td style="padding: 14px 16px; font-size: 14px; color: #E5E7EB; border-bottom: 1px solid #1F2937;">{{ $hire->budget }}</td>
                                </tr>
                                @endif

                                <tr>
                                    <td width="35%" style="padding: 14px 16px; font-size: 13px; font-weight: 600; color: #6B7280; vertical-align: top; text-transform: uppercase; letter-spacing: 0.5px;">Your Notes</td>
                                    <td style="padding: 14px 16px; font-size: 14px; color: #9CA3AF; line-height: 20px; font-style: italic;">
                                        "{{ Str::limit($hire->description, 250) }}"
                                    </td>
                                </tr>
                            </table>

                            <p style="margin: 32px 0 0 0; font-size: 14px; line-height: 22px; color: #9CA3AF;">
                                We've attached our company profile for reference. If you'd like to add anything to your requirements, just reply directly to this email.
                            </p>
                        </td>
                    </tr>
